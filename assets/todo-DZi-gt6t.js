import{c as Ne,r as p,j as e,X as le,a as Se,R as ze}from"./x-CKpBcyvF.js";/* empty css                        */import{s as Q,P as H,C as fe,L as Ce,T as Ee}from"./supabase-DFv7ZDbz.js";import{C as ie}from"./check-B7FBZ1Am.js";/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Te=Ne("Calendar",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]]);async function De(l){const{data:i}=await Q.from("profiles").select("id, name").eq("name",l).maybeSingle();if(i)return i;const{data:x}=await Q.from("profiles").insert({name:l}).select("id, name").single();return x}async function _e(l){const{data:i}=await Q.from("projects").select("*").eq("profile_id",l).order("created_at",{ascending:!1});return i||[]}async function ue(l){await Q.from("projects").upsert(l)}async function Ie(l){await Q.from("projects").delete().eq("id",l)}const V=[{key:"todo",label:"Att göra",color:"#6A6964"},{key:"doing",label:"Pågår",color:"#2E6FD4"},{key:"review",label:"Granskning",color:"#E0A93B"},{key:"done",label:"Klar",color:"#5BAE6E"}],se="ailabb_profile_id",de="ailabb_profile_name",he=()=>{const l=new Date;return l.setMonth(l.getMonth()+1),l.toISOString().split("T")[0]},Me=l=>new Date(l).toLocaleDateString("sv-SE"),Y=l=>{const i=new Date;i.setHours(0,0,0,0);const x=new Date(l);return x.setHours(0,0,0,0),Math.round((x-i)/864e5)},$e=l=>{let i=0,x=0;for(const m of l||[]){x++,m.done&&i++;for(const g of m.children||[]){x++,g.done&&i++;for(const h of g.children||[])x++,h.done&&i++}}return{done:i,total:x}},Pe=()=>e.jsx("a",{href:"../../",className:"tl-logo","aria-label":"Gustav Mattsson — AI Labb",children:e.jsxs("svg",{fill:"currentColor",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 623.04 583.35","aria-hidden":"true",children:[e.jsx("defs",{children:e.jsx("style",{children:`
        ...
        `})}),e.jsx("path",{d:"M232.17,3c7.02-7.42,19.19.1,15.62,9.67-9.95,26.68-27.78,61.43-58.57,88.15-55.09,47.8-70.9,80.05-80.29,122.79-.83,3.78-4.33,6.37-8.19,6.09l-13.61-.98c-5.61-.4-9.92-5.11-9.82-10.73.52-29.28,13.8-103.04,70.2-141.85C183.44,51.41,212.65,23.65,232.17,3Z"}),e.jsx("path",{d:"M74.3,234.65s-22.36,17.42-24.83,29.76c-1.77,8.84,31.32,11.98,50.2,13.05,6.54.37,11.77-5.35,10.78-11.82-1.08-7.08-2.45-16.17-3.61-24.42-2.35-16.66-32.55-6.56-32.55-6.56Z"}),e.jsx("path",{d:"M51.87,290.51s-38.3,9.33-38.3,64.83,12.33,99.9-13.57,145.54c0,0,96.6-69.22,110.75-161.62,3.8-24.79-9.47-49.48-32.56-59.27-8.67-3.68-14.96,9.96-26.32,10.52Z"}),e.jsxs("text",{className:"logo-cls-1",transform:"translate(144.86 300.16)",children:[e.jsx("tspan",{x:"0",y:"0",children:"0"}),e.jsx("tspan",{x:"130",y:"0",children:"100"})]}),e.jsxs("text",{className:"logo-cls-2",transform:"translate(259.2 447.19) scale(1.04 1)",children:[e.jsx("tspan",{x:"0",y:"0",children:"0"}),e.jsx("tspan",{x:"127.28",y:"0",children:"111"})]})]})});function Le(){const[l,i]=p.useState(()=>document.documentElement.getAttribute("data-theme")||"dark"),x=()=>{const m=l==="dark"?"light":"dark";document.documentElement.setAttribute("data-theme",m),localStorage.setItem("ailabb_theme",m),i(m)};return e.jsx("button",{className:"tl-theme-toggle",onClick:x,"aria-label":"Byt tema",children:l==="dark"?e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("circle",{cx:"12",cy:"12",r:"4"}),e.jsx("path",{d:"M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"})]}):e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("path",{d:"M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"})})})}function Ae({activeUser:l,onSwitch:i}){const[x,m]=p.useState(!1);return p.useEffect(()=>{if(!x)return;const g=()=>m(!1),h=setTimeout(()=>document.addEventListener("click",g),0);return()=>{clearTimeout(h),document.removeEventListener("click",g)}},[x]),e.jsxs("div",{className:"tl-user-menu",onClick:g=>g.stopPropagation(),children:[e.jsxs("button",{className:"tl-user-chip",onClick:()=>m(!x),children:[e.jsx("span",{className:"tl-avatar",children:l[0].toUpperCase()}),e.jsx("span",{className:"tl-user-name",children:l}),e.jsx(fe,{size:12,style:{transform:x?"rotate(180deg)":"rotate(0)",transition:"transform 200ms"}})]}),x&&e.jsx("div",{className:"tl-user-dropdown",children:e.jsxs("button",{onClick:()=>{m(!1),i()},children:[e.jsx(Ce,{size:14}),"Byt användare"]})})]})}function ce({value:l,onChange:i,onBlur:x,onKeyDown:m,fontSize:g,fontWeight:h}){return e.jsx("input",{autoFocus:!0,className:"tl-edit-input",value:l,onChange:i,onBlur:x,onKeyDown:m,style:g?{fontSize:g,fontWeight:h}:{}})}function me({project:l,onUpdate:i,onDelete:x,onArchive:m,isArchived:g=!1,showToast:h}){const[$,U]=p.useState(""),[C,P]=p.useState({}),[N,L]=p.useState({}),[G,A]=p.useState(new Set),[E,X]=p.useState(new Set),[f,v]=p.useState(null),[T,D]=p.useState(""),[S,oe]=p.useState(g),[ne,F]=p.useState(!1),[ee,_]=p.useState(!1),[q,K]=p.useState(l.description||""),w=p.useRef(null),u=l.todos||[],k=Y(l.deadline),te=l.checkpoint===V.length-1,{done:I,total:z}=$e(u),O=()=>Date.now().toString()+Math.random().toString(36).slice(2,6),B=()=>new Date().toISOString(),M=(t,r)=>{v(t),D(r)},o=()=>{if(!f)return;const t=T.trim();if(!t){v(null);return}if(f==="__name__"){i({name:t}),v(null);return}const r=f.split("/");if(r.length===1)i({todos:u.map(n=>n.id===r[0]?{...n,text:t}:n)});else if(r.length===2){const[n,a]=r;i({todos:u.map(s=>s.id!==n?s:{...s,children:(s.children||[]).map(c=>c.id===a?{...c,text:t}:c)})})}else{const[n,a,s]=r;i({todos:u.map(c=>c.id!==n?c:{...c,children:(c.children||[]).map(R=>R.id!==a?R:{...R,children:(R.children||[]).map(ae=>ae.id===s?{...ae,text:t}:ae)})})})}v(null)},d=t=>{F(!1),t&&i({deadline:t})},y=()=>{_(!1),i({description:q.trim()})},j=()=>{$.trim()&&(i({todos:[...u,{id:O(),text:$.trim(),done:!1,createdAt:B(),children:[]}]}),U(""))},b=t=>i({todos:u.map(r=>r.id===t?{...r,done:!r.done}:r)}),W=t=>{w.current=u;const r=u.filter(n=>n.id!==t);i({todos:r}),A(n=>{const a=new Set(n);return a.delete(t),a}),h&&h("Todo raderad",()=>i({todos:w.current}))},Z=t=>A(r=>{const n=new Set(r);return n.has(t)?n.delete(t):n.add(t),n}),pe=t=>{const r=(C[t]||"").trim();r&&(i({todos:u.map(n=>n.id!==t?n:{...n,children:[...n.children||[],{id:O(),text:r,done:!1,createdAt:B(),children:[]}]})}),P(n=>({...n,[t]:""})))},ve=(t,r)=>i({todos:u.map(n=>n.id!==t?n:{...n,children:(n.children||[]).map(a=>a.id===r?{...a,done:!a.done}:a)})}),we=(t,r)=>{w.current=u;const n=u.map(a=>a.id!==t?a:{...a,children:(a.children||[]).filter(s=>s.id!==r)});i({todos:n}),X(a=>{const s=new Set(a);return s.delete(`${t}/${r}`),s}),h&&h("Todo raderad",()=>i({todos:w.current}))},xe=(t,r)=>{const n=`${t}/${r}`;X(a=>{const s=new Set(a);return s.has(n)?s.delete(n):s.add(n),s})},ge=(t,r)=>{const n=`${t}/${r}`,a=(N[n]||"").trim();a&&(i({todos:u.map(s=>s.id!==t?s:{...s,children:(s.children||[]).map(c=>c.id!==r?c:{...c,children:[...c.children||[],{id:O(),text:a,done:!1,createdAt:B()}]})})}),L(s=>({...s,[n]:""})))},ke=(t,r,n)=>i({todos:u.map(a=>a.id!==t?a:{...a,children:(a.children||[]).map(s=>s.id!==r?s:{...s,children:(s.children||[]).map(c=>c.id===n?{...c,done:!c.done}:c)})})}),ye=(t,r,n)=>{w.current=u;const a=u.map(s=>s.id!==t?s:{...s,children:(s.children||[]).map(c=>c.id!==r?c:{...c,children:(c.children||[]).filter(R=>R.id!==n)})});i({todos:a}),h&&h("Todo raderad",()=>i({todos:w.current}))};let re="",J="";k<0?(re="overdue",J=`${Math.abs(k)} d försenad`):k===0?(re="urgent",J="Idag"):k<=7?(re="urgent",J=`${k} d kvar`):J=`${k} d kvar`;const je=z>0?Math.round(I/z*100):0;return e.jsxs("div",{className:`tl-project ${g?"archived":""}`,children:[e.jsxs("div",{className:"tl-project-header",children:[e.jsx("button",{className:"tl-collapse-btn",onClick:()=>oe(t=>!t),"aria-label":S?"Expandera":"Minimera",children:e.jsx(fe,{size:18,style:{transform:S?"rotate(-90deg)":"rotate(0)",transition:"transform 200ms"}})}),f==="__name__"?e.jsx("input",{autoFocus:!0,className:"tl-project-name-input",value:T,onChange:t=>D(t.target.value),onBlur:o,onKeyDown:t=>{t.key==="Enter"&&o(),t.key==="Escape"&&v(null)}}):e.jsx("h3",{className:"tl-project-name",onClick:()=>M("__name__",l.name),children:l.name}),z>0&&e.jsxs("span",{className:"tl-todo-counter",children:[I,"/",z," klara"]}),g&&l.archived_at&&e.jsxs("span",{className:"tl-archived-date",children:["Arkiverad ",Me(l.archived_at)]}),!g&&(ne?e.jsx("input",{autoFocus:!0,type:"date",className:"tl-deadline-input",defaultValue:l.deadline,onBlur:t=>d(t.target.value),onKeyDown:t=>{t.key==="Enter"&&d(t.target.value),t.key==="Escape"&&F(!1)}}):e.jsxs("div",{className:`tl-deadline-badge ${re}`,style:{cursor:"pointer"},onClick:()=>F(!0),children:[e.jsx(Te,{size:12}),J]})),te&&!g&&e.jsx("button",{className:"tl-archive-btn",onClick:m,children:"Arkivera"}),e.jsx("button",{className:"tl-icon-btn",onClick:x,"aria-label":"Ta bort projekt",children:e.jsx(Ee,{size:16})})]}),!S&&!g&&e.jsx("div",{className:"tl-project-desc-row",children:ee?e.jsx("input",{autoFocus:!0,className:"tl-desc-input",value:q,placeholder:"Lägg till beskrivning…",onChange:t=>K(t.target.value),onBlur:y,onKeyDown:t=>{t.key==="Enter"&&y(),t.key==="Escape"&&(_(!1),K(l.description||""))}}):e.jsx("span",{className:`tl-project-desc ${l.description?"":"empty"}`,onClick:()=>{K(l.description||""),_(!0)},children:l.description||"Lägg till beskrivning…"})}),z>0&&e.jsx("div",{className:"tl-project-progress-bar",children:e.jsx("div",{className:"tl-project-progress-fill",style:{width:`${je}%`}})}),!S&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"tl-progress",children:V.map((t,r)=>{const n=r<=l.checkpoint;return e.jsxs(p.Fragment,{children:[e.jsxs("button",{className:`tl-progress-step ${r===l.checkpoint?"active":""}`,onClick:()=>i({checkpoint:r}),"aria-label":`Sätt status till ${t.label}`,children:[e.jsx("span",{className:"tl-pdot",style:n?{background:t.color,borderColor:t.color}:{}}),e.jsx("span",{className:"tl-plabel",children:t.label})]}),r<V.length-1&&e.jsx("span",{className:"tl-progress-line",style:r<l.checkpoint?{background:t.color}:{}})]},t.key)})}),e.jsxs("div",{className:"tl-todos",children:[u.length===0&&e.jsx("p",{className:"tl-empty-hint",children:"Inga todos ännu."}),u.map(t=>e.jsxs("div",{className:"tl-todo-block",children:[e.jsxs("div",{className:`tl-row l0 ${t.done?"done":""}`,children:[e.jsx("button",{className:`tl-circle-btn ${t.done?"checked":""}`,onClick:()=>b(t.id),"aria-label":"Markera klar",children:t.done&&e.jsx(ie,{size:10,strokeWidth:3})}),f===t.id?e.jsx(ce,{value:T,onChange:r=>D(r.target.value),onBlur:o,onKeyDown:r=>{r.key==="Enter"&&o(),r.key==="Escape"&&v(null)}}):e.jsx("span",{className:"tl-row-text",onClick:()=>M(t.id,t.text),children:t.text}),e.jsx("button",{className:`tl-add-child-btn ${G.has(t.id)?"open":""}`,onClick:()=>Z(t.id),title:"Lägg till sub-todo",children:e.jsx(H,{size:11,strokeWidth:2.5})}),e.jsx("button",{className:"tl-icon-btn",onClick:()=>W(t.id),"aria-label":"Ta bort",children:e.jsx(le,{size:14})})]}),((t.children||[]).length>0||G.has(t.id))&&e.jsxs("div",{className:"tl-children",children:[(t.children||[]).map(r=>{const n=`${t.id}/${r.id}`;return e.jsxs("div",{className:"tl-todo-block",children:[e.jsxs("div",{className:`tl-row l1 ${r.done?"done":""}`,children:[e.jsx("button",{className:`tl-circle-btn sm ${r.done?"checked":""}`,onClick:()=>ve(t.id,r.id),"aria-label":"Markera klar",children:r.done&&e.jsx(ie,{size:8,strokeWidth:3})}),f===n?e.jsx(ce,{value:T,onChange:a=>D(a.target.value),onBlur:o,onKeyDown:a=>{a.key==="Enter"&&o(),a.key==="Escape"&&v(null)}}):e.jsx("span",{className:"tl-row-text",onClick:()=>M(n,r.text),children:r.text}),e.jsx("button",{className:`tl-add-child-btn sm ${E.has(n)?"open":""}`,onClick:()=>xe(t.id,r.id),title:"Lägg till sub-sub-todo",children:e.jsx(H,{size:10,strokeWidth:2.5})}),e.jsx("button",{className:"tl-icon-btn",onClick:()=>we(t.id,r.id),"aria-label":"Ta bort",children:e.jsx(le,{size:13})})]}),((r.children||[]).length>0||E.has(n))&&e.jsxs("div",{className:"tl-children sub",children:[(r.children||[]).map(a=>{const s=`${t.id}/${r.id}/${a.id}`;return e.jsxs("div",{className:`tl-row l2 ${a.done?"done":""}`,children:[e.jsx("button",{className:`tl-circle-btn sm ${a.done?"checked":""}`,onClick:()=>ke(t.id,r.id,a.id),"aria-label":"Markera klar",children:a.done&&e.jsx(ie,{size:8,strokeWidth:3})}),f===s?e.jsx(ce,{value:T,onChange:c=>D(c.target.value),onBlur:o,onKeyDown:c=>{c.key==="Enter"&&o(),c.key==="Escape"&&v(null)}}):e.jsx("span",{className:"tl-row-text",onClick:()=>M(s,a.text),children:a.text}),e.jsx("button",{className:"tl-icon-btn",onClick:()=>ye(t.id,r.id,a.id),"aria-label":"Ta bort",children:e.jsx(le,{size:12})})]},a.id)}),E.has(n)&&e.jsxs("div",{className:"tl-inline-add",children:[e.jsx("input",{autoFocus:!0,type:"text",placeholder:"Sub-sub-todo…",value:N[n]||"",onChange:a=>L(s=>({...s,[n]:a.target.value})),onKeyDown:a=>{a.key==="Enter"&&ge(t.id,r.id),a.key==="Escape"&&xe(t.id,r.id)}}),e.jsx("button",{onClick:()=>ge(t.id,r.id),disabled:!(N[n]||"").trim(),children:e.jsx(H,{size:12})})]})]})]},r.id)}),G.has(t.id)&&e.jsxs("div",{className:"tl-inline-add",children:[e.jsx("input",{autoFocus:!0,type:"text",placeholder:"Sub-todo…",value:C[t.id]||"",onChange:r=>P(n=>({...n,[t.id]:r.target.value})),onKeyDown:r=>{r.key==="Enter"&&pe(t.id),r.key==="Escape"&&Z(t.id)}}),e.jsx("button",{onClick:()=>pe(t.id),disabled:!(C[t.id]||"").trim(),children:e.jsx(H,{size:12})})]})]})]},t.id)),e.jsxs("div",{className:"tl-add-note",children:[e.jsx("input",{type:"text",placeholder:"Lägg till todo…",value:$,onChange:t=>U(t.target.value),onKeyDown:t=>t.key==="Enter"&&j()}),e.jsxs("button",{onClick:j,disabled:!$.trim(),children:[e.jsx(H,{size:14,strokeWidth:2.5}),"Lägg till"]})]})]})]})]})}function Fe(){const[l,i]=p.useState(null),[x,m]=p.useState(null),[g,h]=p.useState([]),[$,U]=p.useState(!0),[C,P]=p.useState(null),N=p.useRef(null),L=p.useRef({}),[G,A]=p.useState(!1),[E,X]=p.useState(""),[f,v]=p.useState(0),[T,D]=p.useState(he()),S=(o,d)=>{N.current&&clearTimeout(N.current),P({msg:o,undoFn:d||null}),N.current=setTimeout(()=>P(null),4e3)},oe=()=>{N.current&&clearTimeout(N.current),P(null)};p.useEffect(()=>{async function o(){let d=null;try{d=JSON.parse(localStorage.getItem("ailabb_active_user"))}catch{}if(!d){window.location.replace("../../");return}i(d);const y=localStorage.getItem(se),j=localStorage.getItem(de);let b;if(y&&j===d)b=y;else{const Z=await De(d);if(!Z){window.location.replace("../../");return}b=Z.id,localStorage.setItem(se,b),localStorage.setItem(de,d)}m(b);const W=await _e(b);h(W),U(!1)}o()},[]);const ne=()=>{localStorage.removeItem("ailabb_active_user"),localStorage.removeItem(se),localStorage.removeItem(de),window.location.replace("../../")},F=()=>{X(""),v(0),D(he())},ee=async()=>{if(!E.trim())return;const o={id:Date.now().toString(),profile_id:x,name:E.trim(),checkpoint:f,deadline:T,description:"",todos:[],created_at:new Date().toISOString()};h(d=>[o,...d]),F(),A(!1);try{await ue(o)}catch{S("Kunde inte spara ändringarna")}},_=(o,d)=>{const y=g.find(b=>b.id===o);if(!y)return;let j={...y,...d};d.checkpoint!==void 0&&d.checkpoint<V.length-1&&j.archived&&(j={...j,archived:!1,archived_at:null}),h(b=>b.map(W=>W.id===o?j:W)),L.current[o]&&clearTimeout(L.current[o]),L.current[o]=setTimeout(async()=>{try{await ue({...j,profile_id:x})}catch{S("Kunde inte spara ändringarna")}},800)},q=o=>_(o,{archived:!0,archived_at:new Date().toISOString()}),K=async o=>{window.confirm("Ta bort projektet?")&&(h(d=>d.filter(y=>y.id!==o)),await Ie(o))},w=g.filter(o=>!o.archived),u=w.filter(o=>Y(o.deadline)<0),k=w.filter(o=>{const d=Y(o.deadline);return d>=0&&d<=7}),te=w.filter(o=>Y(o.deadline)>7),I=[...u,...k,...te],z=g.filter(o=>o.archived).sort((o,d)=>new Date(d.archived_at||0)-new Date(o.archived_at||0)),O=u.length,B=k.filter(o=>Y(o.deadline)===0).length,M=k.filter(o=>Y(o.deadline)>0).length+te.length;return $?e.jsxs(e.Fragment,{children:[e.jsx(be,{}),e.jsx("div",{className:"tl-fullscreen-loader",children:"Laddar…"})]}):e.jsxs(e.Fragment,{children:[e.jsx(be,{}),e.jsxs("div",{className:"tl-app-root",children:[e.jsxs("nav",{className:"tl-top-nav",children:[e.jsx(Pe,{}),e.jsxs("div",{className:"tl-nav-right",children:[e.jsxs("ul",{className:"tl-menu",children:[e.jsx("li",{children:e.jsx("a",{href:"../../",children:"Hem"})}),e.jsxs("li",{className:"tl-has-dropdown",children:[e.jsxs("a",{href:"#","aria-haspopup":"true",children:["Appar ",e.jsx("span",{className:"tl-chev","aria-hidden":"true",children:"▾"})]}),e.jsxs("ul",{className:"tl-dropdown",role:"menu",children:[e.jsx("li",{role:"none",children:e.jsx("a",{href:"../todo/",role:"menuitem",className:"active",children:"Todo"})}),e.jsx("li",{role:"none",children:e.jsx("a",{href:"../kampanj/",role:"menuitem",children:"Kampanjplanerare"})}),e.jsx("li",{role:"none",children:e.jsx("a",{href:"../seo-audit/",role:"menuitem",children:"SEO & GEO-granskning"})}),e.jsx("li",{role:"none",children:e.jsx("a",{href:"../trackr/",role:"menuitem",children:"Track3r"})})]})]})]}),e.jsx(Le,{}),e.jsx(Ae,{activeUser:l,onSwitch:ne})]})]}),e.jsxs("section",{className:"tl-hero",children:[e.jsxs("h1",{children:["Hej ",l,", redo att ",e.jsx("span",{className:"hand",children:"labba?"})]}),e.jsx("p",{children:"Liten plats för att hålla koll på pågående experiment. Skapa ett projekt, sätt en deadline och samla anteckningar längs vägen."})]}),G?e.jsxs("div",{className:"tl-form-card",children:[e.jsx("h2",{children:"Nytt projekt"}),e.jsxs("div",{className:"tl-field",children:[e.jsx("label",{className:"tl-field-label",children:"Projektnamn"}),e.jsx("input",{type:"text",placeholder:"t.ex. Bygg AI-labbet",value:E,onChange:o=>X(o.target.value),onKeyDown:o=>o.key==="Enter"&&ee(),autoFocus:!0})]}),e.jsxs("div",{className:"tl-field",children:[e.jsx("label",{className:"tl-field-label",children:"Status"}),e.jsx("div",{className:"tl-checkpoints",children:V.map((o,d)=>e.jsxs("button",{type:"button",className:`tl-cp-pill ${f===d?"active":""}`,onClick:()=>v(d),style:f===d?{borderColor:o.color,background:`${o.color}20`}:{},children:[e.jsx("span",{className:"tl-dot",style:{background:o.color}}),o.label]},o.key))})]}),e.jsxs("div",{className:"tl-field",children:[e.jsx("label",{className:"tl-field-label",children:"Deadline"}),e.jsx("input",{type:"date",value:T,onChange:o=>D(o.target.value)})]}),e.jsxs("div",{className:"tl-form-actions",children:[e.jsx("button",{className:"tl-btn-primary",onClick:ee,disabled:!E.trim(),children:"Skapa projekt"}),e.jsx("button",{className:"tl-btn-ghost",onClick:()=>{F(),A(!1)},children:"Avbryt"})]})]}):e.jsxs("button",{className:"tl-new-btn",onClick:()=>A(!0),children:[e.jsx(H,{size:18,strokeWidth:2.5}),"Nytt projekt"]}),e.jsxs("section",{style:{marginTop:28},children:[I.length>0&&e.jsxs("div",{className:"tl-summary-bar",children:[O>0&&e.jsxs("span",{children:[O," försenade"]}),B>0&&e.jsxs("span",{children:[B," idag"]}),M>0&&e.jsxs("span",{children:[M," pågående"]})]}),I.length===0&&z.length===0?e.jsxs("div",{className:"tl-empty-state",children:[e.jsx("h3",{children:"Inga projekt ännu"}),e.jsx("p",{children:"Skapa ditt första projekt för att komma igång."})]}):I.length===0?e.jsxs("div",{className:"tl-empty-state",children:[e.jsx("h3",{children:"Inga aktiva projekt"}),e.jsx("p",{children:"Alla projekt är arkiverade. Skapa ett nytt eller återställ ett nedan."})]}):I.map(o=>e.jsx(me,{project:o,onUpdate:d=>_(o.id,d),onDelete:()=>K(o.id),onArchive:()=>q(o.id),showToast:S},o.id))]}),z.length>0&&e.jsxs("section",{className:"tl-archive-section",children:[e.jsx("h2",{className:"tl-archive-heading",children:"Arkiverade projekt"}),z.map(o=>e.jsx(me,{project:o,isArchived:!0,onUpdate:d=>_(o.id,d),onDelete:()=>K(o.id),onArchive:()=>q(o.id),showToast:S},o.id))]})]}),C&&e.jsxs("div",{className:"tl-toast",children:[e.jsx("span",{children:C.msg}),C.undoFn&&e.jsx("button",{className:"tl-toast-undo",onClick:()=>{C.undoFn(),oe()},children:"Ångra"})]})]})}function be(){return e.jsx("style",{children:`
      /* ── Green theme tokens ── */
      :root {
        --tl-green:        #4ADE80;
    ...
    `})}Se.createRoot(document.getElementById("root")).render(e.jsx(ze.StrictMode,{children:e.jsx(Fe,{})}));
