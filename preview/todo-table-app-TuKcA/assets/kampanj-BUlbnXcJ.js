import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css                        */import{r as h,j as e,c as ie,R as ce}from"./client-BXUeE7ba.js";import{s as P,c as de}from"./supabase-DEtOZO0_.js";import{c as A,X as pe}from"./x-DeBlSGpl.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const me=A("LogOut",[["path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4",key:"1uf3rs"}],["polyline",{points:"16 17 21 12 16 7",key:"1gabdz"}],["line",{x1:"21",x2:"9",y1:"12",y2:"12",key:"1uyos4"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xe=A("Trash2",[["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6",key:"4alrt4"}],["path",{d:"M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2",key:"v07s0e"}],["line",{x1:"10",x2:"10",y1:"11",y2:"17",key:"1uufr5"}],["line",{x1:"14",x2:"14",y1:"11",y2:"17",key:"xtxkd"}]]);async function ue(t){const{data:a}=await P.from("profiles").select("id, name").eq("name",t).maybeSingle();if(a)return a;const{data:r}=await P.from("profiles").insert({name:t}).select("id, name").single();return r}async function ge(t){const{data:a}=await P.from("campaigns").select("*").eq("profile_id",t).order("created_at",{ascending:!1});return a||[]}async function T(t){await P.from("campaigns").upsert(t)}async function he(t){await P.from("campaigns").delete().eq("id",t)}const R=["Instagram","Facebook","TikTok","LinkedIn","Google Ads","YouTube","X","Snapchat"],z={inaktiv:{key:"inaktiv",label:"Inaktiv",short:"Inaktiv",color:"#6A6964"},schemalagd:{key:"schemalagd",label:"Schemalagd",short:"Schemalagd",color:"#E0A93B"},aktiv:{key:"aktiv",label:"Aktiv",short:"Aktiv",color:"#5BAE6E"},klar:{key:"klar",label:"Klar",short:"Klar",color:"#2E6FD4"}},$={upcoming:{key:"upcoming",label:"Kommande",color:"#6A6964"},active:{key:"active",label:"Pågår",color:"#5BAE6E"},completed:{key:"completed",label:"Avslutad",color:"#2E6FD4"}},L="ailabb_profile_id",O="ailabb_profile_name";function B(){return new Date().toISOString().split("T")[0]}function H(t){const a=new Date;return a.setDate(a.getDate()+t),a.toISOString().split("T")[0]}function C(t){return new Date(t).toLocaleDateString("sv-SE",{day:"numeric",month:"short"})}function V(t){return!t||isNaN(t)?"0 kr":new Intl.NumberFormat("sv-SE").format(t)+" kr"}function J(t,a){const r=new Date;r.setHours(0,0,0,0);const s=new Date(t);s.setHours(0,0,0,0);const l=new Date(a);return l.setHours(0,0,0,0),r<s?$.upcoming:r>l?$.completed:$.active}function G(t){const a=new Date;a.setHours(0,0,0,0);const r=new Date(t);return r.setHours(0,0,0,0),a<r?"schemalagd":"aktiv"}function Q(t){if(t.status==="schemalagd"){const a=new Date;a.setHours(0,0,0,0);const r=new Date(t.start);if(r.setHours(0,0,0,0),a>=r)return{...t,status:"aktiv"}}return t}function fe(t){let a=!1;return{campaigns:t.map(s=>({...s,platforms:(s.platforms||[]).map(l=>{const n=Q(l);return n!==l&&(a=!0),n})})),changed:a}}function ke(t,a){const r=[],s=new Date(t),l=new Date(a),n=new Date(s.getFullYear(),s.getMonth(),1);for(;n<=l;)r.push({date:new Date(n),label:n.toLocaleDateString("sv-SE",{month:"short"}).replace(".","")}),n.setMonth(n.getMonth()+1);return r}function M(t,a,r){const s=new Date(t).getTime(),l=new Date(a).getTime(),n=new Date(r).getTime();return n===l?0:Math.max(0,Math.min(100,(s-l)/(n-l)*100))}function E(t,a){return{name:"",budget:0,start:t,end:a,status:G(t)}}const be=()=>e.jsx("a",{href:"../../",className:"kl-logo","aria-label":"Gustav Mattsson — AI Labb",children:e.jsxs("svg",{fill:"currentColor",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 623.04 583.35","aria-hidden":"true",children:[e.jsx("defs",{children:e.jsx("style",{children:`
        ...
        `})}),e.jsx("path",{d:"M232.17,3c7.02-7.42,19.19.1,15.62,9.67-9.95,26.68-27.78,61.43-58.57,88.15-55.09,47.8-70.9,80.05-80.29,122.79-.83,3.78-4.33,6.37-8.19,6.09l-13.61-.98c-5.61-.4-9.92-5.11-9.82-10.73.52-29.28,13.8-103.04,70.2-141.85C183.44,51.41,212.65,23.65,232.17,3Z"}),e.jsx("path",{d:"M74.3,234.65s-22.36,17.42-24.83,29.76c-1.77,8.84,31.32,11.98,50.2,13.05,6.54.37,11.77-5.35,10.78-11.82-1.08-7.08-2.45-16.17-3.61-24.42-2.35-16.66-32.55-6.56-32.55-6.56Z"}),e.jsx("path",{d:"M51.87,290.51s-38.3,9.33-38.3,64.83,12.33,99.9-13.57,145.54c0,0,96.6-69.22,110.75-161.62,3.8-24.79-9.47-49.48-32.56-59.27-8.67-3.68-14.96,9.96-26.32,10.52Z"}),e.jsxs("text",{className:"logo-cls-1",transform:"translate(144.86 300.16)",children:[e.jsx("tspan",{x:"0",y:"0",children:"0"}),e.jsx("tspan",{x:"130",y:"0",children:"100"})]}),e.jsxs("text",{className:"logo-cls-2",transform:"translate(259.2 447.19) scale(1.04 1)",children:[e.jsx("tspan",{x:"0",y:"0",children:"0"}),e.jsx("tspan",{x:"127.28",y:"0",children:"111"})]})]})});function ve(){const[t,a]=h.useState(()=>document.documentElement.getAttribute("data-theme")||"dark"),r=()=>{const s=t==="dark"?"light":"dark";document.documentElement.setAttribute("data-theme",s),localStorage.setItem("ailabb_theme",s),a(s)};return e.jsx("button",{className:"kl-theme-toggle",onClick:r,"aria-label":"Byt tema",children:t==="dark"?e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("circle",{cx:"12",cy:"12",r:"4"}),e.jsx("path",{d:"M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"})]}):e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("path",{d:"M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"})})})}function we({activeUser:t,onSwitch:a}){const[r,s]=h.useState(!1);return h.useEffect(()=>{if(!r)return;const l=()=>s(!1),n=setTimeout(()=>document.addEventListener("click",l),0);return()=>{clearTimeout(n),document.removeEventListener("click",l)}},[r]),e.jsxs("div",{className:"kl-user-menu",onClick:l=>l.stopPropagation(),children:[e.jsxs("button",{className:"kl-user-chip",onClick:()=>s(!r),children:[e.jsx("span",{className:"kl-avatar",children:t[0].toUpperCase()}),e.jsx("span",{className:"kl-user-name",children:t}),e.jsx(Z,{size:12,style:{transform:r?"rotate(180deg)":"rotate(0)",transition:"transform 200ms"}})]}),r&&e.jsx("div",{className:"kl-user-dropdown",children:e.jsxs("button",{onClick:()=>{s(!1),a()},children:[e.jsx(me,{size:14}),"Byt användare"]})})]})}function ye({start:t,end:a}){const r=new Date(t),s=new Date(a),l=new Date,n=s-r,p=Math.max(0,Math.min(n,l-r)),i=n>0?p/n*100:0,f=J(t,a),w=f.key==="active",m=f.key==="completed",u=Math.max(1,Math.ceil(n/864e5)),y=m?100:w?i:0;return e.jsxs("div",{className:"kl-timeline",children:[e.jsxs("div",{className:"kl-timeline-labels",children:[e.jsx("span",{children:C(t)}),e.jsxs("span",{className:"duration",children:[u," ",u===1?"dag":"dagar"]}),e.jsx("span",{children:C(a)})]}),e.jsxs("div",{className:"kl-timeline-bar",style:{marginBottom:w?24:0},children:[e.jsx("div",{className:"kl-timeline-fill",style:{width:`${y}%`,background:f.color}}),w&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"kl-timeline-today",style:{left:`${i}%`}}),e.jsx("div",{className:"kl-timeline-today-label",style:{left:`${i}%`},children:"Idag"})]})]})]})}function je({campaign:t}){const a=t.platforms||[];if(a.length===0)return null;const r=ke(t.start,t.end),s=new Date,l=s>=new Date(t.start)&&s<=new Date(t.end),n=l?M(s.toISOString(),t.start,t.end):null;return e.jsxs("div",{children:[e.jsx("div",{className:"kl-section-label",children:"Kampanjöversikt"}),e.jsxs("div",{className:"kl-cal",children:[e.jsx("div",{className:"kl-cal-header",children:r.map((p,i)=>e.jsx("span",{className:"kl-cal-month",style:{left:`${M(p.date,t.start,t.end)}%`},children:p.label},i))}),a.map((p,i)=>{const f=M(p.start,t.start,t.end),w=M(p.end,t.start,t.end),m=Math.max(.5,w-f),u=z[p.status]||z.aktiv,y=p.status==="inaktiv";return e.jsxs("div",{className:"kl-cal-row",children:[e.jsx("span",{className:`kl-cal-row-label ${y?"inaktiv":""}`,children:p.name||"Plattform"}),e.jsxs("div",{className:"kl-cal-track",children:[r.map((x,k)=>k===0?null:e.jsx("span",{className:"kl-cal-line",style:{left:`${M(x.date,t.start,t.end)}%`}},k)),l&&i===0&&e.jsx("span",{className:"kl-cal-today-line",style:{left:`${n}%`}}),e.jsx("div",{className:`kl-cal-bar ${y?"inaktiv":""}`,style:y?{left:`${f}%`,width:`${m}%`}:{left:`${f}%`,width:`${m}%`,background:u.color},title:`${p.name}: ${C(p.start)} – ${C(p.end)} (${u.short})`})]})]},i)})]})]})}function Ne({campaign:t,onDelete:a,onUpdatePlatform:r,onAddPlatform:s}){const[l,n]=h.useState(!1),p=J(t.start,t.end),i=t.platforms||[],f=i.reduce((m,u)=>m+(Number(u.budget)||0),0),w=`${C(t.start)} – ${C(t.end)}`;return e.jsxs("div",{className:`kl-campaign ${l?"open":""}`,children:[e.jsxs("button",{className:"kl-campaign-header",onClick:()=>n(!l),"aria-expanded":l,children:[e.jsxs("div",{className:"kl-campaign-title",children:[e.jsx("span",{className:"kl-campaign-client",children:t.client}),e.jsx("span",{className:"kl-campaign-name",children:t.name})]}),e.jsx("span",{className:"kl-meta-pill",children:w}),e.jsx("span",{className:"kl-meta-pill budget",children:V(f)}),e.jsxs("span",{className:`kl-meta-pill status ${p.key}`,children:[e.jsx("span",{className:"sdot",style:{background:p.color}}),p.label]}),e.jsx(Z,{size:18,className:"kl-chevron"})]}),l&&e.jsxs("div",{className:"kl-campaign-body",children:[e.jsx(ye,{start:t.start,end:t.end}),e.jsxs("div",{children:[e.jsx("div",{className:"kl-section-label",children:"Plattformar"}),e.jsxs("div",{className:"kl-platform-list",children:[i.length===0?e.jsx("p",{className:"kl-pl-empty-hint",children:"Inga plattformar tillagda än."}):i.map((m,u)=>{const y=z[m.status]||z.aktiv;return e.jsxs("div",{className:`kl-pl-item ${m.status==="inaktiv"?"inaktiv":""}`,children:[e.jsxs("div",{className:"kl-pl-row-top",children:[e.jsxs("div",{className:"kl-pl-name",children:[e.jsx("span",{className:"pdot",style:{background:y.color}}),e.jsx("input",{type:"text",className:"kl-pl-inline-input kl-pl-name-input",value:m.name,onChange:x=>r(u,{name:x.target.value}),placeholder:"Plattform","aria-label":"Plattformnamn"})]}),e.jsxs("div",{className:"kl-pl-budget-edit",children:[e.jsx("input",{type:"number",className:"kl-pl-inline-input",min:"0",step:"100",value:m.budget||"",onChange:x=>r(u,{budget:Number(x.target.value)||0}),placeholder:"0","aria-label":"Budget"}),e.jsx("span",{className:"suffix",children:"kr"})]})]}),e.jsxs("div",{className:"kl-pl-row-bottom",children:[e.jsxs("div",{className:"kl-pl-dates-edit",children:[e.jsx("input",{type:"date",className:"kl-pl-inline-input",value:m.start,min:t.start,max:m.end||t.end,onChange:x=>r(u,{start:x.target.value}),"aria-label":"Startdatum"}),e.jsx("span",{className:"dash",children:"–"}),e.jsx("input",{type:"date",className:"kl-pl-inline-input",value:m.end,min:m.start||t.start,max:t.end,onChange:x=>r(u,{end:x.target.value}),"aria-label":"Slutdatum"})]}),e.jsx("div",{className:"kl-status-seg compact",role:"radiogroup","aria-label":"Plattformsstatus",children:Object.values(z).map(x=>e.jsxs("button",{type:"button",role:"radio","aria-checked":m.status===x.key,className:m.status===x.key?"active":"",onClick:()=>r(u,{status:x.key}),title:x.label,children:[e.jsx("span",{className:"sdot",style:{background:x.color}}),x.short]},x.key))})]})]},u)}),i.length>0&&e.jsxs("div",{className:"kl-pl-total",children:[e.jsx("span",{className:"label",children:"Total budget"}),e.jsx("span",{className:"value",children:V(f)})]}),e.jsxs("button",{className:"kl-pl-add-btn",onClick:s,children:[e.jsx(K,{size:14,strokeWidth:2.5}),"Lägg till plattform"]})]})]}),e.jsx(je,{campaign:t}),e.jsx("div",{className:"kl-body-actions",children:e.jsxs("button",{className:"kl-btn-danger",onClick:a,children:[e.jsx(xe,{size:14}),"Ta bort kampanj"]})})]})]})}function Se({platform:t,onChange:a,onRemove:r,canRemove:s,campaignStart:l,campaignEnd:n,suggestionIndex:p}){return e.jsxs("div",{className:"kl-platform-card",children:[e.jsxs("div",{className:"kl-pc-row top",children:[e.jsx("input",{type:"text",placeholder:R[p%R.length],value:t.name,onChange:i=>a({name:i.target.value}),list:"kl-platform-suggestions"}),e.jsxs("div",{className:"kl-pc-budget-wrap",children:[e.jsx("input",{type:"number",min:"0",step:"100",placeholder:"Budget",value:t.budget,onChange:i=>a({budget:i.target.value})}),e.jsx("span",{className:"currency",children:"kr"})]}),e.jsx("button",{type:"button",className:"kl-icon-btn danger",onClick:r,disabled:!s,"aria-label":"Ta bort plattform",children:e.jsx(pe,{size:16})})]}),e.jsxs("div",{className:"kl-pc-row dates",children:[e.jsxs("div",{children:[e.jsx("span",{className:"kl-pc-mini-label",children:"Start"}),e.jsx("input",{type:"date",value:t.start,min:l,max:n,onChange:i=>a({start:i.target.value})})]}),e.jsxs("div",{children:[e.jsx("span",{className:"kl-pc-mini-label",children:"Slut"}),e.jsx("input",{type:"date",value:t.end,min:t.start||l,max:n,onChange:i=>a({end:i.target.value})})]})]}),e.jsx("div",{className:"kl-pc-row status",children:e.jsxs("div",{children:[e.jsx("span",{className:"kl-pc-mini-label",children:"Status"}),e.jsx("div",{className:"kl-status-seg",role:"radiogroup","aria-label":"Plattformsstatus",children:Object.values(z).map(i=>e.jsxs("button",{type:"button",role:"radio","aria-checked":t.status===i.key,className:t.status===i.key?"active":"",onClick:()=>a({status:i.key}),children:[e.jsx("span",{className:"sdot",style:{background:i.color}}),i.label]},i.key))})]})})]})}function ze(){const[t,a]=h.useState(null),[r,s]=h.useState(null),[l,n]=h.useState([]),[p,i]=h.useState(!0),[f,w]=h.useState(!1),[m,u]=h.useState(""),[y,x]=h.useState(""),[k,W]=h.useState(B()),[N,Y]=h.useState(H(30)),[S,I]=h.useState([E(B(),H(30))]);h.useEffect(()=>{async function o(){let c=null;try{c=JSON.parse(localStorage.getItem("ailabb_active_user"))}catch{}if(!c){window.location.replace("../../");return}if(!await de()){window.location.replace("../../");return}a(c);const g=localStorage.getItem(L),b=localStorage.getItem(O);let v;if(g&&b===c)v=g;else{const j=await ue(c);if(!j){window.location.replace("../../");return}v=j.id,localStorage.setItem(L,v),localStorage.setItem(O,c)}s(v);const _=await ge(v),{campaigns:D,changed:F}=fe(_);n(D),F&&D.forEach(j=>T(j)),i(!1)}o()},[]);const ee=()=>{localStorage.removeItem("ailabb_active_user"),localStorage.removeItem(L),localStorage.removeItem(O),window.location.replace("../../")},q=()=>{u(""),x("");const o=B(),c=H(30);W(o),Y(c),I([E(o,c)])},te=(o,c)=>{I(S.map((d,g)=>{if(g!==o)return d;const b={...d,...c};return"start"in c&&(b.status==="schemalagd"||b.status==="aktiv")&&(b.status=G(b.start)),b}))},ae=()=>I([...S,E(k,N)]),re=o=>I(S.filter((c,d)=>d!==o)),U=m.trim()&&y.trim()&&k&&N&&new Date(N)>=new Date(k),oe=async()=>{if(!U)return;const o=S.filter(d=>d.name.trim()||d.budget).map(d=>({name:d.name.trim()||"Plattform",budget:Number(d.budget)||0,start:d.start||k,end:d.end||N,status:d.status||G(d.start||k)})),c={id:Date.now().toString(),profile_id:r,client:m.trim(),name:y.trim(),start:k,end:N,platforms:o,created_at:new Date().toISOString()};n(d=>[c,...d]),q(),w(!1),await T(c)},le=async o=>{window.confirm("Ta bort kampanjen?")&&(n(c=>c.filter(d=>d.id!==o)),await he(o))},ne=async(o,c,d)=>{const g=l.map(v=>{if(v.id!==o)return v;const _=(v.platforms||[]).map((D,F)=>{if(F!==c)return D;let j={...D,...d};return j=Q(j),j});return{...v,platforms:_}});n(g);const b=g.find(v=>v.id===o);b&&await T({...b,profile_id:r})},se=async o=>{const c=l.map(g=>{if(g.id!==o)return g;const b=E(g.start,g.end);return{...g,platforms:[...g.platforms||[],b]}});n(c);const d=c.find(g=>g.id===o);d&&await T({...d,profile_id:r})};return p?e.jsxs(e.Fragment,{children:[e.jsx(X,{}),e.jsx("div",{className:"kl-fullscreen-loader",children:"Laddar…"})]}):e.jsxs(e.Fragment,{children:[e.jsx(X,{}),e.jsxs("div",{className:"kl-app-root",children:[e.jsxs("nav",{className:"kl-top-nav",children:[e.jsx(be,{}),e.jsxs("div",{className:"kl-nav-right",children:[e.jsxs("ul",{className:"kl-menu",children:[e.jsx("li",{children:e.jsx("a",{href:"../../",children:"Hem"})}),e.jsxs("li",{className:"kl-has-dropdown",children:[e.jsxs("a",{href:"#","aria-haspopup":"true",children:["Appar ",e.jsx("span",{className:"kl-chev","aria-hidden":"true",children:"▾"})]}),e.jsxs("ul",{className:"kl-dropdown",role:"menu",children:[e.jsx("li",{role:"none",children:e.jsx("a",{href:"../todo/",role:"menuitem",children:"Todo"})}),e.jsx("li",{role:"none",children:e.jsx("a",{href:"../kampanj/",role:"menuitem",className:"active",children:"Kampanjplanerare"})}),e.jsx("li",{role:"none",children:e.jsx("a",{href:"../seo-audit/",role:"menuitem",children:"SEO & GEO-granskning"})})]})]})]}),e.jsx(ve,{}),e.jsx(we,{activeUser:t,onSwitch:ee})]})]}),e.jsxs("section",{className:"kl-hero",children:[e.jsxs("h1",{children:["Hej ",t,", dags att ",e.jsx("span",{className:"hand",children:"planera?"})]}),e.jsx("p",{children:"Bygg och håll koll på kampanjer åt dina kunder. Varje plattform kan köras under egna perioder inom kampanjen."})]}),f?e.jsxs("div",{className:"kl-form-card",children:[e.jsx("h2",{children:"Ny kampanj"}),e.jsxs("div",{className:"kl-field-row",children:[e.jsxs("div",{className:"kl-field",children:[e.jsx("label",{className:"kl-field-label",children:"Kund"}),e.jsx("input",{type:"text",placeholder:"t.ex. IKEA",value:m,onChange:o=>u(o.target.value),autoFocus:!0})]}),e.jsxs("div",{className:"kl-field",children:[e.jsx("label",{className:"kl-field-label",children:"Kampanjnamn"}),e.jsx("input",{type:"text",placeholder:"t.ex. Sommarkampanj 2026",value:y,onChange:o=>x(o.target.value)})]})]}),e.jsxs("div",{className:"kl-field-row",children:[e.jsxs("div",{className:"kl-field",children:[e.jsx("label",{className:"kl-field-label",children:"Startdatum"}),e.jsx("input",{type:"date",value:k,onChange:o=>W(o.target.value)})]}),e.jsxs("div",{className:"kl-field",children:[e.jsx("label",{className:"kl-field-label",children:"Slutdatum"}),e.jsx("input",{type:"date",value:N,onChange:o=>Y(o.target.value),min:k})]})]}),e.jsxs("div",{className:"kl-field",children:[e.jsx("label",{className:"kl-field-label",children:"Plattformar & budget"}),e.jsxs("div",{className:"kl-platforms",children:[S.map((o,c)=>e.jsx(Se,{platform:o,onChange:d=>te(c,d),onRemove:()=>re(c),canRemove:S.length>1,campaignStart:k,campaignEnd:N,suggestionIndex:c},c)),e.jsx("datalist",{id:"kl-platform-suggestions",children:R.map(o=>e.jsx("option",{value:o},o))}),e.jsxs("button",{type:"button",className:"kl-btn-secondary",style:{alignSelf:"flex-start"},onClick:ae,children:[e.jsx(K,{size:14,strokeWidth:2.5}),"Lägg till plattform"]})]})]}),e.jsxs("div",{className:"kl-form-actions",children:[e.jsx("button",{className:"kl-btn-primary",onClick:oe,disabled:!U,children:"Skapa kampanj"}),e.jsx("button",{className:"kl-btn-ghost",onClick:()=>{q(),w(!1)},children:"Avbryt"})]})]}):e.jsxs("button",{className:"kl-new-btn",onClick:()=>w(!0),children:[e.jsx(K,{size:18,strokeWidth:2.5}),"Ny kampanj"]}),e.jsx("section",{style:{marginTop:28},children:l.length===0?e.jsxs("div",{className:"kl-empty-state",children:[e.jsx("h3",{children:"Inga kampanjer ännu"}),e.jsx("p",{children:"Skapa din första kampanj för att komma igång."})]}):l.map(o=>e.jsx(Ne,{campaign:o,onDelete:()=>le(o.id),onUpdatePlatform:(c,d)=>ne(o.id,c,d),onAddPlatform:()=>se(o.id)},o.id))})]})]})}function X(){return e.jsx("style",{children:`
    ...
    `})}ie.createRoot(document.getElementById("root")).render(e.jsx(ce.StrictMode,{children:e.jsx(ze,{})}));
